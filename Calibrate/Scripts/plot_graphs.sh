...
#################################################################################################################
RESULTS_FOLDER=~/printer_data/config/Calibrate/Results # Path to the folder where storing the results files
SCRIPTS_FOLDER=~/printer_data/config/Calibrate/Scripts # Path to the folder where the graph_vibrations.py is located
